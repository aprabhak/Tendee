...
public class Result_AttendeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_attendee);
        ...
        final String name =getIntent().getStringExtra("Attendee_Name");
...
//                Toast.makeText(Search_ResultActivity.this, Long.toString(dataSnapshot.getChildrenCount()), Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Result_AttendeeActivity.this, "FAILED", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mMakeappBtm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Attendee_Name", mResName.getText());
